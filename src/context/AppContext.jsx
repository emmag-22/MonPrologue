...
const translations = {
  ...
  // ── Clinic bilingual strings ──
  'clinic.logout': { fr: 'Se déconnecter', en: 'Log out' },
  'clinic.back': { fr: '← Tableau de bord', en: '← Dashboard' },
  'clinic.download.transcript': { fr: '↓ Télécharger', en: '↓ Transcript' },
  'clinic.download.pdf': { fr: '⎙ Télécharger PDF', en: '⎙ Download PDF' },
  'clinic.case.brief': { fr: 'DOSSIER', en: 'CASE BRIEF' },
  'clinic.case.deadlines': { fr: 'ÉCHÉANCES', en: 'DEADLINE TRACKER' },
  'clinic.case.narrative': { fr: 'Résumé narratif', en: 'Narrative Summary' },
  'clinic.case.timeline': { fr: 'Chronologie', en: 'Event Timeline' },
  'clinic.case.geo': { fr: 'Contexte géopolitique', en: 'Geopolitical Context' },
  'clinic.case.geo.sources': { fr: 'SOURCES', en: 'SOURCES' },
  'clinic.case.geo.empty': { fr: 'Contexte géopolitique non disponible.', en: 'Geopolitical context not available.' },
  'clinic.case.flags': { fr: 'Signalements', en: 'Red Flags' },
  'clinic.case.flags.deadlines': { fr: '4A — ALERTES ÉCHÉANCES', en: '4A — DEADLINE ALERTS' },
  'clinic.case.flags.none': { fr: 'Aucune échéance imminente.', en: 'No imminent deadlines.' },
  'clinic.case.flags.exclusions': { fr: '4B — EXCLUSIONS LÉGALES', en: '4B — LEGAL EXCLUSION SCREENING' },
  'clinic.case.flags.narrative': { fr: '4C — SIGNALEMENTS NARRATIFS', en: '4C — NARRATIVE FLAGS' },
  'clinic.case.flags.narrative.hint': { fr: 'Cliquez pour aller à la réponse dans l\'Annexe. Les lacunes peuvent refléter un traumatisme.', en: 'Click a flag to scroll to the relevant answer in the Appendix. Gaps may reflect trauma or translation.' },
  'clinic.case.similar': { fr: 'Décisions similaires de la CISR', en: 'Similar IRB Decisions' },
  'clinic.case.similar.loading': { fr: 'Chargement des cas similaires…', en: 'Loading similar cases…' },
  'clinic.case.similar.none': { fr: 'Aucun cas similaire trouvé.', en: 'No similar cases found.' },
  'clinic.case.similar.note': { fr: 'Modèles illustratifs. Cliquez pour chercher sur CanLII. Vérifiez toutes les citations avant utilisation.', en: 'Illustrative case patterns. Click titles to search CanLII. Verify all citations before use in any legal proceeding.' },
  'clinic.case.appendix': { fr: 'Annexe — Transcription complète', en: 'Appendix — Full Conversation Transcript' },
  'clinic.case.disclaimer': { fr: 'Ce dossier n\'évalue pas la véracité du récit du demandeur. Les lacunes narratives peuvent refléter un traumatisme, une fragmentation de la mémoire ou des problèmes de traduction, et doivent être explorées avec compassion par le professionnel juridique. Cet outil ne constitue pas un avis juridique.', en: 'This dossier does not assess the truthfulness of the claimant\'s account. Narrative gaps may reflect trauma, memory fragmentation, or translation issues, and must be explored compassionately by the legal professional. This tool does not constitute legal advice.' },
  'clinic.case.analysis': { fr: 'Analyse juridique', en: 'Legal Analysis' },
  'clinic.case.citations': { fr: 'Citations LIPR', en: 'IRPA Citations' },
  'clinic.case.actions': { fr: 'Actions recommandées', en: 'Recommended Actions' },
  'clinic.case.resources': { fr: 'Ressources identifiées', en: 'Matched Resources' },
  'clinic.case.ground': { fr: 'Analyse du motif de la Convention', en: 'Convention Ground Analysis' },
  'clinic.case.coherence': { fr: 'Questions pour le conseiller', en: 'Coherence Flags — Questions for Counsel' },
  'clinic.case.coherence.note': { fr: 'Ce sont des questions de préparation, non des jugements de crédibilité.', en: 'These are preparation questions, not credibility judgments. Gaps may reflect trauma, memory fragmentation, or translation.' },
  'clinic.case.ifa': { fr: 'Évaluation de la PRI', en: 'IFA Assessment' },
  'clinic.case.state': { fr: 'Protection de l\'État', en: 'State Protection' },
  'clinic.dashboard.empty': { fr: 'Aucun dossier', en: 'No cases' },
  'clinic.legend.1': { fr: 'Audience imminente / Menace explicite', en: 'Imminent hearing / Explicit threat' },
  'clinic.legend.2': { fr: 'Audience dans 30 jours / Dossier ancien', en: 'Hearing in 30 days / Old file' },
  'clinic.legend.3': { fr: 'Audience dans 60 jours', en: 'Hearing in 60 days' },
  'clinic.legend.4': { fr: 'Nouveau dossier', en: 'New case' },
  'clinic.tabs.open': { fr: 'Dossiers ouverts', en: 'Open cases' },
  'clinic.tabs.working': { fr: 'En traitement', en: 'Working' },
  'clinic.tabs.archived': { fr: 'Archivés', en: 'Archived' },
}
